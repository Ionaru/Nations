...
public enum NationType {
    ...
    SPAIN(1,"Spain", "The very first settlement in the New World was built by Christopher Columbus in 1492 from the remains of the Spanish ship 'The Santa María', he called it 'La Navidad'. The settlement was on the island what is now known as Haiti. \nSpain went on to colonize the Caribbean Islands, Mexico and large parts of north and south America.", "Chance of extra drops while mining."),
